...
--   | n == 2 = True
--   | even n = False
--   | otherwise = not (any (\x -> n `mod` x == 0) (takeWhile (\x -> x * x <= n) [3, 5 ..]))

-- -- Función que obtiene todos los divisores de un número
-- divisores :: Int -> [Int]
-- divisores n = filter (\x -> n `mod` x == 0) [1..n]

-- -- Función principal que cuenta los divisores primos
-- cantDivisoresPrimos :: Int -> Int
